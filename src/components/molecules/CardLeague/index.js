...
const CardLeague = ({ gambar1, tim1, p1, gd1, pts1, gambar2, tim2, p2, gd2, pts2, gambar3, tim3, p3, gd3, pts3, gambar4, tim4, p4, gd4, pts4, gambar5, tim5, p5, gd5, pts5}) => {
  return (
    <>
                ...
                <table className="text-[16px] font-thin">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td className="px-3 py-3">{p5}</td>
                            <td className="px-3 py-3">{gd5}</td>
                            <td className="px-3 py-3">{pts5}</td>
                        </tr>
                        <tr>
                            <td className="px-3 py-3">
                                <p>...</p>
