        ...
        <div className="flex flex-row justify-around py-12">
          <div className="text-white lg:w-[550px] w-[100px]">
            ...
            <p className="font-thin">
              Jl. Pararaton (off Sunset Road), Legian, Kuta, Bali 80361 Phone :
              (0361) 960 9893
            </p>
            <h2 className="font-bold pt-3">Office Jakarta</h2>
            <p className="font-thin">
              Jl. Panjang Raya No.29 11520 Jakarta Barat Daerah Khusus Ibukota
              Jakarta
            </p>
          ...
          <div className="text-white justify-center flex flex-col w-[100px]">
            ...
            <Link
              href={"/home/#news"}
              className="font-thin py-2 hover:text-blue-700"
            >
              Trending
            </Link>
            <Link
              href={"/home/#media"}
              className="font-thin hover:text-blue-700"
            >
              Media
            </Link>
          </div>
