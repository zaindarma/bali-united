    ...
    <>
      ...
      <section class="w-full h-full flex justify-center px-[130px] bg-gray-100 text-black">
        <div class="flex flex-col items-center bg-white pb-20">
          <Image
            src="https://baliutd.oss-ap-southeast-5.aliyuncs.com//files/uploads/news/image/2025/Jan/19/678cec4f290ef/img-20250119-wa0018-1280x590.jpg?token=fd53a3c12b3ac8881407f04ab128078a"
            alt=""
            width={1280}
            height={1280}
          />
